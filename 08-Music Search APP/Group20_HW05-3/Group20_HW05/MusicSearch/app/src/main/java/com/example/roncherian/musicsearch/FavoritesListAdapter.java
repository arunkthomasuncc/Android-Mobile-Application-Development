...
/**
 * Created by roncherian on 08/10/17.
 */

public class FavoritesListAdapter extends ArrayAdapter<MusicTrack> {
    ...
    public FavoritesListAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<MusicTrack> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //ImageButton imageButton = (ImageButton)convertView.findViewById(R.id.imageButtonFavorite);
        ...
        favoriteImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //mObjects.remove(musicTrack);
                ((ArrayList<MusicTrack>)mObjects).remove(musicTrack);
