...
public class UserDetailPostActivityRecyclerViewAdapter extends RecyclerView.Adapter<UserDetailPostActivityRecyclerViewAdapter.ViewHolder>{
    ...
    public UserDetailPostActivityRecyclerViewAdapter(ArrayList<Post> mData,Context context) {
        this.mData = mData;
    ...
    @Override
    public UserDetailPostActivityRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final UserDetailPostActivityRecyclerViewAdapter.ViewHolder holder, int position) {
